...
def create_doc10():
	for i in range(10):
		data = {
		"_id": i,
		# "text": "Шановні мешканці! Повідомляємо, 03 лютого 2022р, з 11.00 - до 12.00 годині буде, відтсутня гаряча водопостачання, в зв'язку з ремонтом мережі. Управляюча компанія.",
		"text": "Шановні мешканці! Повідомляємо, 03 лютого 2022р, з 11.00 - до 12.00 годині буде, відбудуться збори, щодо вирішення питань по облаштуванню парковки.",
